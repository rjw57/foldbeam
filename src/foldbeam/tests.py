...
class TestUtility(unittest.TestCase):
    def test_create_render_dataset(self):
        ...
        r1 = _gdal.create_render_dataset((0,0,1,1), srs, (256, 128))
    ...
    def test_transform_envelope(self):
        ...
        envelope = (412148-100, 142251-100, 200, 200)
        ...
        self.assertTrue(-1.826189 - lnglat_envelope[0] < lnglat_envelope[2])
        self.assertTrue(51.178844 - lnglat_envelope[1] < lnglat_envelope[3])
...
class TestRasterNode(unittest.TestCase):
    ...
    def test_render_node(self):
        envelope = (369475, 205525, 1429*50, 1887*-50)
...
class TestTileStacheRasterNode(unittest.TestCase):
    ...
    def test_tilestache_lat_lng(self):
        envelope = (-180, 89.995, 360, -179.99)
        envelope_srs = SpatialReference()
    ...
    def test_tilestache_osgrid(self):
        envelope = (0, 1300000, 700000, -1300000)
        envelope_srs = SpatialReference()
        envelope_srs.ImportFromEPSG(27700) # British national grid
    ...
    def test_tilestache_big_ben(self):
        ...
        envelope = (centre[0]-0.5*skirt, centre[1]+0.5*skirt, skirt, -skirt)
