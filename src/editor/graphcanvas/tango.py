...
def paint_pad(cr, scheme, x, y, orientation, size, highlight=False, well_color=None):
    ...
    elif well_color is not None:
        linear_blend = cairo.LinearGradient(minx,miny,maxx,maxy)
        linear_blend.add_color_stop_rgb(0.0, *well_color)
        linear_blend.add_color_stop_rgb(1.0, *[0.5*x + 0.5 for x in well_color])
